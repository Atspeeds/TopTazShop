...
namespace ServiceHost.Models
{
    ...
    {
        private readonly ICatalogTypeQuery getMenuItemService;
        public MenuItemTagHelper(ICatalogTypeQuery getMenuItemService)
        {
        ...
        {
            var data = getMenuItemService.Get();
        ...
        private TagBuilder CreateSub(List<MenoItemDto> data, MenoItemDto sub1, int count, out int IndexCount)
        {
            IndexCount = count;
